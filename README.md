...
- Internal pipeline tracker (analyst initials, assignment and presentation dates;
  also surfaces as each market page's "Last analyzed" pill and drives
  sync_analysis_decks.py, which renders each market's newest Market Analysis
  PowerPoint into the Market Analysis tab) from the
